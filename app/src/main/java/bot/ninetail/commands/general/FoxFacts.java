    ...
    static {
        setContents(FoxFacts.class, 
            new String[]{
                ...
                "They have partially retractable claws, much like cats, giving them excellent grip for climbing and silent movement.",
                ...
                "They can jump high fences and cover over 6 feet in a single leap, making them surprisingly agile escape artists.",
                ...
                "They sometimes \"mouse pounce\" for fun, even when they're not hungry—possibly to keep their skills sharp.",
                ...
                "They groom each other in social pairs, not just to stay clean but also to strengthen social bonds.",
