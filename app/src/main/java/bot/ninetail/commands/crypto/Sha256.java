...
public final class Sha256 implements CryptographyCommand {
    @Nonnull
    private static final System.Logger LOGGER = System.getLogger(Sha256.class.getName());
    ...
    public static void invoke(SlashCommandInteractionEvent event) {
        LOGGER.log(System.Logger.Level.INFO, "SHA-256 command invoked by {0} ({1}) of guild {2} ({3})", 
