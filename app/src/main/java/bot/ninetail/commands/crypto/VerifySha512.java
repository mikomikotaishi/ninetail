...
public final class VerifySha512 implements CryptographyCommand {
    @Nonnull
    private static final System.Logger LOGGER = System.getLogger(VerifySha512.class.getName());
    ...
    public static void invoke(SlashCommandInteractionEvent event) {
        LOGGER.log(System.Logger.Level.INFO, "Verify SHA-512 command invoked by {0} ({1}) of guild {2} ({3})", 
