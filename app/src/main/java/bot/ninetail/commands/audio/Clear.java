...
public final class Clear implements AudioCommand {
    @Nonnull
    private static final System.Logger LOGGER = System.getLogger(Clear.class.getName());
    ...
    public static void invoke(@Nonnull SlashCommandInteractionEvent event) {
        LOGGER.log(System.Logger.Level.INFO, "Clear queue command invoked by {0} ({1}) of guild {2} ({3})", 
