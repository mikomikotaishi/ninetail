...
public final class Skip implements AudioCommand {
    @Nonnull
    private static final System.Logger LOGGER = System.getLogger(Skip.class.getName());
    ...
    public static void invoke(@Nonnull SlashCommandInteractionEvent event) {
        LOGGER.log(System.Logger.Level.INFO, "Skip command invoked by {0} ({1}) of guild {2} ({3})", 
