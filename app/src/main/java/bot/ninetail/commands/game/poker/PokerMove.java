...
public final class PokerMove implements GameCommand {
    @Nonnull
    private static final System.Logger LOGGER = System.getLogger(PokerMove.class.getName());
    ...
    public static void invoke(@Nonnull SlashCommandInteractionEvent event) {
        LOGGER.log(System.Logger.Level.INFO, "Poker move command invoked by {0} ({1}) of guild {2} ({3})", 
