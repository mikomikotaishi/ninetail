...
public final class ChessMove implements GameCommand {
    @Nonnull
    private static final System.Logger LOGGER = System.getLogger(ChessMove.class.getName());
    ...
    public static void invoke(@Nonnull SlashCommandInteractionEvent event) {
        LOGGER.log(System.Logger.Level.INFO, "Chess move command invoked by {0} ({1}) of guild {2} ({3})", 
