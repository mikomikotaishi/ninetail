...
public final class DatabaseHandler {
    ...
    public static void loadDatabase() {
        try {
            LOGGER.log(System.Logger.Level.INFO, "Initialising database connection...");
            ...
            LOGGER.log(System.Logger.Level.ERROR, "Failed to initialise database due to SQL exception: {0}", e.getMessage());
            LOGGER.log(System.Logger.Level.WARNING, "Social commands that require the database will be unavailable!");
        } catch (PoolInitializationException e) {
            LOGGER.log(System.Logger.Level.ERROR, "Failed to initialise database due to database handling exception: {0}", e.getMessage());
            LOGGER.log(System.Logger.Level.WARNING, "Social commands that require the database will be unavailable!");
        } catch (Exception e) {
            LOGGER.log(System.Logger.Level.ERROR, "Failed to initialise database: {0}", e.getMessage());
            LOGGER.log(System.Logger.Level.WARNING, "Social commands that require the database will be unavailable!");
        }
    }
}
